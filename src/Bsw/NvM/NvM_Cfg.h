 ...
 *          ファイルに相当する。
 *
 *          本プロジェクトの EEPROM レイアウト (Arduino UNO 内蔵 1KB の先頭 36 バイト):
 ...
 *            Addr 0x0022: NVM_BLOCK_ID_DEM_EXTENDED CRC   (1 byte)
 *
...
#define NVM_BLOCK_DEM_EXTENDED_EEPROM_ADDR 0x0018U  /**< 故障確定回数の先頭アドレス (CRC は 0x0022) */
