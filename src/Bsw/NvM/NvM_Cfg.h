 ...
 *          ファイルに相当する。
 *
 *          本プロジェクトの EEPROM レイアウト (Arduino UNO 内蔵 1KB の先頭 5 バイト):
 *            Addr 0x0000: NVM_BLOCK_ID_DEM_MAGIC  (1 byte)  — DEM 有効マーカー
 *            Addr 0x0001: NVM_BLOCK_ID_DEM_STATUS (4 bytes) — DEM イベントステータス
 *
...
#define NVM_BLOCK_ID_DEM_STATUS   1U  /**< DEM イベントステータス (4 bytes)   */
...
#define NVM_BLOCK_DEM_STATUS_LENGTH   4U  /**< DEM_EVENT_COUNT = 4 イベント分   */
