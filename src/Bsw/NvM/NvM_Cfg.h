 ...
 *          ファイルに相当する。
 *
 *          本プロジェクトの EEPROM レイアウト (Arduino UNO 内蔵 1KB の先頭 6 バイト):
 *            Addr 0x0000: NVM_BLOCK_ID_DEM_MAGIC  (1 byte)  — DEM 有効マーカー
 *            Addr 0x0001: NVM_BLOCK_ID_DEM_STATUS (5 bytes) — DEM イベントステータス
 *
...
#define NVM_BLOCK_ID_DEM_STATUS   1U  /**< DEM イベントステータス (5 bytes)   */
...
#define NVM_BLOCK_DEM_STATUS_LENGTH   5U  /**< DEM_EVENT_COUNT = 5 イベント分   */
