 ...
 *          直接呼ぶところから始める（`test/Bsw_ComStack_RxE2E_test.cpp`
...
// test/Bsw_ComStack_RxE2E_test.cpp の kRefEngineInfoCfg と同じ）。
...
protected:
    ...
    // （test/Bsw_ComStack_RxE2E_test.cpp の BuildFrame() と同じ）。
