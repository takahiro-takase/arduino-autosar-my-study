/**
 * \file    Bsw_DcmStack_SID3E_TesterPresent_test.cpp
 * \brief   UDS SID 0x3E TesterPresent の、物理層（Can_Hw フェイク）を
 ...
 *          `TesterPresent_NG_ExtraByteReturnsIncorrectMessageLength`
...
class Bsw_DcmStack_SID3E_TesterPresent_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
