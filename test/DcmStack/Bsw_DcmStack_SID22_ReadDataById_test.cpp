/**
 * \file    Bsw_DcmStack_SID22_ReadDataById_test.cpp
 ...
 *
 * \details Bsw_DcmStack_SID19_SF04_ReadDtcSnapshot_test.cpp 系列で
...
class Bsw_DcmStack_SID22_ReadDataById_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
