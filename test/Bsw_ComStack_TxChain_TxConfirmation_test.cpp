/**
 * \file    Bsw_ComStack_TxChain_TxConfirmation_test.cpp
...
class Bsw_ComStack_TxChain_TxConfirmation_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_TxChain_TxConfirmation_Test, TxConfirmation_OK_CallsSignalGroupAckCbkExactlyOnce)
{
...
TEST_F(Bsw_ComStack_TxChain_TxConfirmation_Test, TxConfirmation_NG_NonGroupIPduDoesNotCallGroupAckCbk)
{
