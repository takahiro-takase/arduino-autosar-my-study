/**
 * \file    Bsw_DcmStack_SID19_DispatchChain_test.cpp
 ...
 *
 * \details Bsw_DcmStack_SID19_SF01/SF02/SF04/SF06/SF0A/SF14_*Chain_test.cpp
 ...
 *          なった場合も、`Bsw_DcmStack_SID<xx>_DispatchChain_test.cpp` という
 *          同じ命名規則を使う。
 */
...
class Bsw_DcmStack_SID19_DispatchChain_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_DcmStack_SID19_DispatchChain_Test,
