/**
 * \file    Bsw_DcmStack_SID19_SF14_ReadDtcFaultDetectionCounterChain_test.cpp
 ...
 *
 * \details Bsw_DcmStack_SID19_SF01_ReadDtcCountChain_test.cpp で確立した
 ...
 *          （SID19_SF0A_ReadDtcSupportedChain_test.cpp とは異なる）。
 *
...
class Bsw_DcmStack_SID19_SF14_ReadDtcFaultDetectionCounterChain_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_DcmStack_SID19_SF14_ReadDtcFaultDetectionCounterChain_Test,
