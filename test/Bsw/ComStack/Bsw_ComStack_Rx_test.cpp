 ...
 *
 *          Tx処理コールチェーン（Bsw_ComStack_Tx_ComSendSignal_test.cpp）と同じ発想で「非同期の
 ...
 *
 *          Bsw_ComStack_Tx_ComSendSignal_test.cpp と同じ理由・同じ最小構成方針（本番の
 ...
 *          リンクしている（Bsw_Sleep_test.cpp / Bsw_NmStack_Wakeup_test.cpp
...
// -----------------------------------------------------------------------
// テスト専用の最小 Com/PduR/CanIf 設定（Bsw_ComStack_Tx_ComSendSignal_test.cpp と同じ方針）。
...
// （Bsw_ComStack_Tx_TmsTransition_test.cpp 等の TMS/TxAckCbk/TxErrCbk テスト群と同じ理由で、
...
class Bsw_Rx_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_Rx_Test, CanMainFunctionRead_OK_DrivesToComReceiveSignal)
{
...
TEST_F(Bsw_Rx_Test, CanMainFunctionRead_NG_NothingReceived_LeavesInitValue)
{
    /* 準備 (Arrange): 受信フレームなし */
...
// ------------------------------------------------------------
TEST_F(Bsw_Rx_Test, CanMainFunctionRead_NG_InsufficientDlcIsDiscardedAndReportsRuntimeError)
{
...
// ------------------------------------------------------------
TEST_F(Bsw_Rx_Test, CanIfReadRxPduData_OK_ReturnsBufferedDataAfterReceive)
{
...
TEST_F(Bsw_Rx_Test, CanIfReadRxPduData_NG_ReturnsErrorBeforeAnyReceive)
{
    /* 準備 (Arrange): 一切受信させない */
...
TEST_F(Bsw_Rx_Test, CanIfReadRxPduData_NG_NotOptedInReturnsErrorEvenAfterReceive)
{
...
TEST_F(Bsw_Rx_Test, CanIfReadRxPduData_NG_UnknownPduIdReturnsError)
{
    /* 実行 (Act) + 評価 (Assert) */
    uint8 buf[CANIF_MAX_DLC] = {0U};
    PduInfoType info = { buf, 0U };
...
TEST_F(Bsw_Rx_Test, CanIfReadRxPduData_NG_NullPointerReturnsError)
{
    /* 実行 (Act) + 評価 (Assert) */
    EXPECT_EQ(CanIf_ReadRxPduData(0U, NULL), E_NOT_OK);
}

TEST_F(Bsw_Rx_Test, CanIfReadRxPduData_OK_ClampsBufferedLengthToPduDlcNotModuleMax)
{
...
TEST_F(Bsw_Rx_Test, CanIfInit_NG_RejectsConfigWithRxPduCountAboveMaxWithoutActivating)
{
...
// ------------------------------------------------------------
TEST_F(Bsw_Rx_Test, ComRxIndication_OK_AcceptedByCalloutProcessesNormally)
{
...
TEST_F(Bsw_Rx_Test, ComRxIndication_NG_RejectedByCalloutDiscardsFrameEntirely)
{
...
// ------------------------------------------------------------
TEST_F(Bsw_Rx_Test, ComRxIndication_OK_NonGroupAck_FiresOnFullReception)
{
...
TEST_F(Bsw_Rx_Test, ComRxIndication_OK_NonGroupAck_FiresOncePerFrame)
{
    /* 準備 (Arrange) */
    uint8 buf[2] = { 0x12U, 0x34U };
    PduInfoType pduInfo = { buf, 2U };
...
TEST_F(Bsw_Rx_Test, ComRxIndication_OK_GroupAck_FiresOnceRegardlessOfMemberCount)
{
...
TEST_F(Bsw_Rx_Test, ComRxIndication_NG_GroupAck_DoesNotFireOnShortFrameDiscard)
{
...
TEST_F(Bsw_Rx_Test, ComRxIndication_OK_PartialReception_OnlyAcksSignalsWithinRecvLen)
{
