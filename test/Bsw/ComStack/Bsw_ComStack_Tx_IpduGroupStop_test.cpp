/**
 * \file    Bsw_ComStack_Tx_IpduGroupStop_test.cpp
...
class Bsw_ComStack_Tx_IpduGroupStop_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_IpduGroupStop_Test, IpduGroupStop_OK_CallsSignalGroupErrCbkExactlyOnceWhenUnconfirmed)
{
...
TEST_F(Bsw_ComStack_Tx_IpduGroupStop_Test, IpduGroupStop_NG_DoesNotCallErrCbkWhenAlreadyConfirmed)
{
