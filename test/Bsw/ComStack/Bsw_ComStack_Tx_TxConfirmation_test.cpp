/**
 * \file    Bsw_ComStack_Tx_TxConfirmation_test.cpp
 * \brief   README.md「Tx 処理（Com → PduR → CanIf → Can の順）」コールチェーンの
 *          単体テスト（GoogleTest / CMake native_chain_tests）。TxConfirmation シナリオ専用。
 *
...
class Bsw_ComStack_Tx_TxConfirmation_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_TxConfirmation_Test, TxConfirmation_OK_CallsSignalGroupAckCbkExactlyOnce)
{
...
TEST_F(Bsw_ComStack_Tx_TxConfirmation_Test, TxConfirmation_NG_NonGroupIPduDoesNotCallGroupAckCbk)
{
