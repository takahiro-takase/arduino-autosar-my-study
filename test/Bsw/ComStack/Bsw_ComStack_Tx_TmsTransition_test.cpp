/**
 * \file    Bsw_ComStack_Tx_TmsTransition_test.cpp
 * \brief   README.md「Tx 処理（Com → PduR → CanIf → Can の順）」コールチェーンの
 *          単体テスト（GoogleTest / CMake native_chain_tests）。TmsTransition シナリオ専用。
 *
...
class Bsw_ComStack_Tx_TmsTransition_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ことを示す回帰テスト）。
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_TmsTransition_Test, TmsTransition_OK_TriggersImmediateSendWithoutGroupTrigger)
{
