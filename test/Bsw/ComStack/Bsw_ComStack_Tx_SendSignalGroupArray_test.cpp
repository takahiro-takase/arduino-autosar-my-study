/**
 * \file    Bsw_ComStack_Tx_SendSignalGroupArray_test.cpp
 * \brief   README.md「Tx 処理（Com → PduR → CanIf → Can の順）」コールチェーンの
 *          単体テスト（GoogleTest / CMake native_chain_tests）。SendSignalGroupArray シナリオ専用。
 *
...
class Bsw_ComStack_Tx_SendSignalGroupArray_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_SendSignalGroupArray_Test, SendSignalGroupArray_OK_WritesBufferTriggersSendAndSetsUpdateBit)
{
...
TEST_F(Bsw_ComStack_Tx_SendSignalGroupArray_Test, SendSignalGroupArray_OK_AlwaysTriggersEvenWithoutChange)
{
...
TEST_F(Bsw_ComStack_Tx_SendSignalGroupArray_Test, SendSignalGroupArray_NG_NullDataPtrReturnsError)
{
    /* 実行 (Act) + 評価 (Assert) */
...
TEST_F(Bsw_ComStack_Tx_SendSignalGroupArray_Test, SendSignalGroupArray_NG_NonSignalGroupIPduReturnsError)
{
...
TEST_F(Bsw_ComStack_Tx_SendSignalGroupArray_Test, SendSignalGroupArray_OK_SyncsShadowBufferPreventingStaleOverwrite)
{
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_SendSignalGroupArray_Test, SendSignalGroupArray_OK_ReturnsServiceNotAvailableWhenGroupStoppedButStillWrites)
{
