/**
 * \file    Bsw_ComStack_Tx_IpduGroupStopRepeatsRemaining_test.cpp
...
class Bsw_ComStack_Tx_IpduGroupStopRepeatsRemaining_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// キャンセルする。
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_IpduGroupStopRepeatsRemaining_Test, IpduGroupStopRepeatsRemaining_OK_ClearsRepeatsRemaining)
{
