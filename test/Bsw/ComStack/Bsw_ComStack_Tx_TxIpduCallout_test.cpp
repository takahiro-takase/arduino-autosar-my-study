...
class Bsw_ComStack_Tx_TxIpduCallout_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
// Com_TxIpduCallout（SWS_Com_00346、TX I-PDU 単位のフィルタリングフック）。
// Bsw_ComStack_Rx_test.cpp の Com_RxIpduCallout テストと対になる、送信側の検証。
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_TxIpduCallout_Test, TxIpduCallout_OK_AcceptedTransmitsNormally)
{
...
TEST_F(Bsw_ComStack_Tx_TxIpduCallout_Test, TxIpduCallout_NG_RejectedDiscardsTransmission)
{
    /* 準備 (Arrange) */
