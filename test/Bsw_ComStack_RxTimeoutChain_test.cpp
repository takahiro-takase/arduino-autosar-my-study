 ...
 *
 *          Tx 処理コールチェーン（Bsw_ComStack_TxChain_ComSendSignal_test.cpp）の `Com_TxPending` と
 ...
 *          巨大なため（Bsw_ComStack_TxChain_ComSendSignal_test.cpp 冒頭コメントと同じ理由）、1シグナル・
...
// -----------------------------------------------------------------------
// テスト専用の最小 Com 設定（Bsw_ComStack_TxChain_ComSendSignal_test.cpp/Bsw_ComStack_RxChain_test.cpp と
