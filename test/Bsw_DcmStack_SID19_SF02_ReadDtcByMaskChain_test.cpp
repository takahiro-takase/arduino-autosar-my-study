/**
 * \file    Bsw_DcmStack_SID19_SF02_ReadDtcByMaskChain_test.cpp
 * \brief   UDS SID 0x19/0x02 reportDTCByStatusMask の、物理層（Can_Hw
 *          フェイク）を起点・終点とするフルコールチェーンテスト
 *          （GoogleTest / CMake native_chain_tests）。
 *
 * \details Bsw_DcmStack_SID19_SF01_ReadDtcCountChain_test.cpp（Single Frame
 *          専用）と Bsw_DcmStack_SID19_SF0A_ReadDtcSupportedChain_test.cpp
 ...
 *          完全一致することだけを確認する
 *          （Bsw_DcmStack_SID19_SF0A_ReadDtcSupportedChain_test.cpp と同じ
 *          検証方針）。
 */
...
class Bsw_DcmStack_SID19_SF02_ReadDtcByMaskChain_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_DcmStack_SID19_SF02_ReadDtcByMaskChain_Test,
