/**
 * \file    Bsw_ComStack_TxChain_TxTOut_test.cpp
...
class Bsw_ComStack_TxChain_TxTOut_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_TxChain_TxTOut_Test, TxTOut_OK_FiresAfterFirstTimeoutWhenArmedAndUnconfirmed)
{
...
TEST_F(Bsw_ComStack_TxChain_TxTOut_Test, TxTOut_OK_RepeatsDoNotRestartOrExtendDeadline)
{
...
TEST_F(Bsw_ComStack_TxChain_TxTOut_Test, TxTOut_OK_ConfirmationBeforeDeadlineCancelsIt)
{
...
TEST_F(Bsw_ComStack_TxChain_TxTOut_Test, TxTOut_OK_UsesSteadyTimeoutAfterFirstConfirmedCycle)
{
