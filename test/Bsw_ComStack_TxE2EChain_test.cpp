 ...
 *          CanIf_Transmit() → Can_Write()）は Bsw_ComStack_TxChain_ComSendSignal_test.cpp が既に検証
 ...
 *          自体は Bsw_ComStack_TxChain_ComSendSignal_test.cpp の対象外（TxTransformCbk=NULL の設定）
 ...
 *          E2EXf_PBCfg.c 自体は Rte 依存を持たないため、Bsw_ComStack_TxChain_ComSendSignal_test.cpp
...
// -----------------------------------------------------------------------
// テスト専用の最小 Com/PduR/CanIf 設定（Bsw_ComStack_TxChain_ComSendSignal_test.cpp と同じ方針）。
