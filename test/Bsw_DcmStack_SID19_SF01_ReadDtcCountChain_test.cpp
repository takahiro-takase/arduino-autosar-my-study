/**
 * \file    Bsw_DcmStack_SID19_SF01_ReadDtcCountChain_test.cpp
 ...
 *          （Bsw_ComStack_RxChain_test.cpp 等）と同じ流儀で、本番の
...
class Bsw_DcmStack_SID19_SF01_ReadDtcCountChain_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_DcmStack_SID19_SF01_ReadDtcCountChain_Test,
