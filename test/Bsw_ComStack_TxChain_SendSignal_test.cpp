/**
 * \file    Bsw_ComStack_TxChain_SendSignal_test.cpp
...
class Bsw_ComStack_TxChain_SendSignal_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_TxChain_SendSignal_Test, SendSignal_OK_ReturnsServiceNotAvailableWhenGroupStoppedButStillWritesShadowBuffer)
{
