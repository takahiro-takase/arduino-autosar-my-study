/**
 * \file    Bsw_ComStack_TxChain_TmsUnchanged_test.cpp
...
class Bsw_ComStack_TxChain_TmsUnchanged_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ことを示す回帰テスト）。
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_TxChain_TmsUnchanged_Test, TmsUnchanged_OK_DoesNotTriggerSendWithoutGroupTrigger)
{
