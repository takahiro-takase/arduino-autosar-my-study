/**
 * \file    Bsw_ComStack_TxChain_ComMainFunction_test.cpp
...
class Bsw_ComStack_TxChain_ComMainFunction_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_TxChain_ComMainFunction_Test, ComMainFunction_OK_DrivesChainToCanHwSend)
{
