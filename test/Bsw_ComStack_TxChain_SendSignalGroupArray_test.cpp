/**
 * \file    Bsw_ComStack_TxChain_SendSignalGroupArray_test.cpp
...
class Bsw_ComStack_TxChain_SendSignalGroupArray_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_TxChain_SendSignalGroupArray_Test, SendSignalGroupArray_OK_WritesBufferTriggersSendAndSetsUpdateBit)
{
...
TEST_F(Bsw_ComStack_TxChain_SendSignalGroupArray_Test, SendSignalGroupArray_OK_AlwaysTriggersEvenWithoutChange)
{
...
TEST_F(Bsw_ComStack_TxChain_SendSignalGroupArray_Test, SendSignalGroupArray_NG_NullDataPtrReturnsError)
{
    /* 実行 (Act) + 評価 (Assert) */
...
TEST_F(Bsw_ComStack_TxChain_SendSignalGroupArray_Test, SendSignalGroupArray_NG_NonSignalGroupIPduReturnsError)
{
...
TEST_F(Bsw_ComStack_TxChain_SendSignalGroupArray_Test, SendSignalGroupArray_OK_SyncsShadowBufferPreventingStaleOverwrite)
{
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_TxChain_SendSignalGroupArray_Test, SendSignalGroupArray_OK_ReturnsServiceNotAvailableWhenGroupStoppedButStillWrites)
{
