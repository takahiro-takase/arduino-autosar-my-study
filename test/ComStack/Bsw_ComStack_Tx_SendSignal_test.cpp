/**
 * \file    Bsw_ComStack_Tx_SendSignal_test.cpp
 * \brief   README.md「Tx 処理（Com → PduR → CanIf → Can の順）」コールチェーンの
 *          単体テスト（GoogleTest / CMake native_chain_tests）。SendSignal シナリオ専用。
 *
...
class Bsw_ComStack_Tx_SendSignal_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_SendSignal_Test, SendSignal_OK_ReturnsServiceNotAvailableWhenGroupStoppedButStillWritesShadowBuffer)
{
