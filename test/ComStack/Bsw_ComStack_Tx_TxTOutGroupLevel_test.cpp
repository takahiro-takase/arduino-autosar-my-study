/**
 * \file    Bsw_ComStack_Tx_TxTOutGroupLevel_test.cpp
 * \brief   README.md「Tx 処理（Com → PduR → CanIf → Can の順）」コールチェーンの
 *          単体テスト（GoogleTest / CMake native_chain_tests）。TxTOutGroupLevel シナリオ専用。
 *
 * \details 2026-09-21、Bsw_ComStack_Tx_TxTOut_test.cpp から分離した。
 *          Bsw_ComStack_Tx_TxTOut_test.cpp が検証するシグナル単位の
...
class Bsw_ComStack_Tx_TxTOutGroupLevel_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_TxTOutGroupLevel_Test, TxTOutGroupLevel_OK_FiresWhenStartedAndOverdue)
{
