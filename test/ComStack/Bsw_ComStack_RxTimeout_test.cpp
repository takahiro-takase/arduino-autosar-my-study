/**
 * \file    Bsw_ComStack_RxTimeout_test.cpp
 ...
 *
 *          Tx 処理コールチェーン（Bsw_ComStack_Tx_ComSendSignal_test.cpp）の `Com_TxPending` と
 ...
 *          （`--gtest_filter=Bsw_RxTimeout_Test.ComMainFunction_*` 等で
 *          絞り込み可）。
 *
 *          この非同期境界の検知はどちらも Com.c 内で完結する（PduR/CanIf/Can/
 *          CanSM は経由しない）ため、Tx/Rx チェーンと異なりフェイクは
 *          `millis()`（`test/stub/Hal/Fake_Millis.c`）のみで足りる。
 ...
 *          巨大なため（Bsw_ComStack_Tx_ComSendSignal_test.cpp 冒頭コメントと同じ理由）、1シグナル・
...
// -----------------------------------------------------------------------
// テスト専用の最小 Com 設定（Bsw_ComStack_Tx_ComSendSignal_test.cpp/Bsw_ComStack_Rx_test.cpp と
...
class Bsw_RxTimeout_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_RxTimeout_Test, ComMainFunction_OK_DetectsTimeoutAfterThresholdElapsed)
{
...
TEST_F(Bsw_RxTimeout_Test, ComMainFunction_NG_BeforeThreshold_LeavesSigTimedOutClear)
{
...
TEST_F(Bsw_RxTimeout_Test, ComMainFunction_OK_SigRxTOutCbkFiresOnlyOnceAcrossRepeatedCalls)
{
...
// ------------------------------------------------------------
TEST_F(Bsw_RxTimeout_Test, ComMainFunction_NG_RejectedFrameStillResetsDeadlineTimer)
{
...
TEST_F(Bsw_RxTimeout_Test, ComMainFunction_OK_RejectedFrameStillTransitionsToSteadyTimeout)
{
...
TEST_F(Bsw_RxTimeout_Test, ComMainFunction_NG_GroupShortFrameDiscardStillResetsDeadlineTimer)
{
...
// ------------------------------------------------------------
TEST_F(Bsw_RxTimeout_Test, ComMainFunction_OK_GroupRxTOutFiresAfterThresholdElapsed)
{
    /* 準備 (Arrange) */
    ReceiveOnceGroup();
    FakeMillis_Value = 600UL;
...
TEST_F(Bsw_RxTimeout_Test, ComMainFunction_NG_GroupBeforeThreshold_DoesNotFire)
{
    /* 準備 (Arrange) */
    ReceiveOnceGroup();
    FakeMillis_Value = 400UL;
...
TEST_F(Bsw_RxTimeout_Test, ComMainFunction_NG_MisconfiguredGroupMemberDoesNotDoubleFire)
{
...
// ------------------------------------------------------------
TEST_F(Bsw_RxTimeout_Test, ComReceiveSignal_OK_SubstitutesValueAfterTimeout)
{
...
TEST_F(Bsw_RxTimeout_Test, ComReceiveSignal_NG_BeforeTimeout_ReturnsLastReceivedValue)
{
...
class Bsw_RxIpduGroup_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(Bsw_RxIpduGroup_Test, ComMainFunction_NG_StoppedGroupedIPduNeverTimesOutRegardlessOfElapsed)
{
...
TEST_F(Bsw_RxIpduGroup_Test, ComIpduGroupStart_OK_GroupedIPduBeginsMonitoringAfterExplicitStart)
{
...
TEST_F(Bsw_RxIpduGroup_Test, ComIpduGroupStop_OK_StoppingAgainSuppressesTimeoutEvenAfterElapsed)
{
...
// 隙間の是正）。
// ------------------------------------------------------------
TEST_F(Bsw_RxIpduGroup_Test, ComIpduGroupStop_OK_NonGroupSignalFreezesInsteadOfSubstitutingWhileStopped)
{
...
// ------------------------------------------------------------
TEST_F(Bsw_RxIpduGroup_Test, ComReceiveSignalGroup_OK_ReturnsServiceNotAvailableWhenGroupStopped)
{
...
TEST_F(Bsw_RxIpduGroup_Test, ComReceiveSignalGroupArray_OK_ReturnsServiceNotAvailableWhenGroupStoppedButStillCopies)
{
...
TEST_F(Bsw_RxIpduGroup_Test, ComIpduGroupStart_OK_NonGroupSignalTimesOutAndSubstitutesAfterExplicitStart)
{
...
// ------------------------------------------------------------
TEST_F(Bsw_RxIpduGroup_Test, ComEnableDisableReceptionDM_OK_TogglesFlagForMatchingGroupIPdusOnly)
{
...
TEST_F(Bsw_RxIpduGroup_Test, DisableReceptionDM_OK_SuppressesGroupTimeoutWhileIpduGroupStaysStarted)
{
...
TEST_F(Bsw_RxIpduGroup_Test, EnableReceptionDM_OK_ResetsTimerAndResumesDetectionWithoutImmediateFalseTimeout)
{
...
TEST_F(Bsw_RxIpduGroup_Test, DisableReceptionDM_NG_UnknownIpduGroupIdHasNoEffect)
{
...
// ------------------------------------------------------------
TEST_F(Bsw_RxIpduGroup_Test, DisableReceptionDM_NG_MixedRxTxGroupIsIgnoredEntirely)
{
    /* 準備 (Arrange): 不要。既定で有効なまま */
...
TEST_F(Bsw_RxIpduGroup_Test, EnableReceptionDM_NG_MixedRxTxGroupIsIgnoredEntirely)
{
