/**
 * \file    Bsw_ComStack_Tx_ComMainFunction_test.cpp
 * \brief   README.md「Tx 処理（Com → PduR → CanIf → Can の順）」コールチェーンの
 *          単体テスト（GoogleTest / CMake native_chain_tests）。ComMainFunction シナリオ専用。
 *
...
class Bsw_ComStack_Tx_ComMainFunction_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_ComMainFunction_Test, ComMainFunction_OK_DrivesToCanHwSend)
{
...
TEST_F(Bsw_ComStack_Tx_ComMainFunction_Test, ComMainFunction_NG_NothingPending_DoesNotReachCanHw)
{
...
TEST_F(Bsw_ComStack_Tx_ComMainFunction_Test, ComMainFunction_NG_Can_Write_CAN_BUSY)
{
