/**
 * \file    Bsw_ComStack_Tx_InvalidateSignalGroup_test.cpp
...
class Bsw_ComStack_Tx_InvalidateSignalGroup_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_InvalidateSignalGroup_Test, InvalidateSignalGroup_OK_WritesMemberInvalidValueAndCommitsToBuffer)
{
...
TEST_F(Bsw_ComStack_Tx_InvalidateSignalGroup_Test, InvalidateSignalGroup_NG_AnyMemberUnconfiguredReturnsServiceNotAvailableWithoutPartialCommit)
{
