/**
 * \file    Bsw_ComStack_Tx_RepetitionSequence_test.cpp
 * \brief   README.md「Tx 処理（Com → PduR → CanIf → Can の順）」コールチェーンの
 *          単体テスト（GoogleTest / CMake native_chain_tests）。RepetitionSequence シナリオ専用。
 *
...
class Bsw_ComStack_Tx_RepetitionSequence_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_RepetitionSequence_Test, RepetitionSequence_OK_FiresConfiguredNumberOfRepeatsThenStops)
{
    /* 準備 (Arrange) */
...
TEST_F(Bsw_ComStack_Tx_RepetitionSequence_Test, RepetitionSequence_OK_InitialSendDoesNotConsumeRepeatBudgetEvenWhenElapsedAlreadyExceedsPeriod)
{
...
TEST_F(Bsw_ComStack_Tx_RepetitionSequence_Test, RepetitionSequence_OK_DoesNotConsumeBudgetWhileCommunicationControlDisabled)
{
...
TEST_F(Bsw_ComStack_Tx_RepetitionSequence_Test, RepetitionSequence_NG_DoesNotFireBeforePeriodElapsed)
{
...
TEST_F(Bsw_ComStack_Tx_RepetitionSequence_Test, RepetitionSequence_OK_NewSendSignalRestartsSequence)
{
