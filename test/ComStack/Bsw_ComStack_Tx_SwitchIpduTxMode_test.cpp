/**
 * \file    Bsw_ComStack_Tx_SwitchIpduTxMode_test.cpp
...
class Bsw_ComStack_Tx_SwitchIpduTxMode_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// を流用する。
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_Tx_SwitchIpduTxMode_Test, SwitchIpduTxMode_OK_FlipsStateAndTriggersImmediateSend)
{
...
TEST_F(Bsw_ComStack_Tx_SwitchIpduTxMode_Test, SwitchIpduTxMode_NG_NoEffectWhenModeAlreadyActive)
{
...
TEST_F(Bsw_ComStack_Tx_SwitchIpduTxMode_Test, SwitchIpduTxMode_OK_TogglingBackTriggersAnotherSend)
{
...
TEST_F(Bsw_ComStack_Tx_SwitchIpduTxMode_Test, SwitchIpduTxMode_NG_UnknownPduIdHasNoEffect)
{
...
// Bsw_ComStack_Tx_SwitchIpduTxMode_Test（上記）は TX I-PDU 4 本（COM_TX_IPDU_MAX と同数）を
...
class Bsw_ComStack_Tx_SwitchIpduTxModePeriodic_Test : public IsolatedComTxFixtureBase
{
protected:
    const Com_ConfigType* GetComConfig() const override { return &kTestComConfig; }
};

TEST_F(Bsw_ComStack_Tx_SwitchIpduTxModePeriodic_Test, SwitchIpduTxMode_OK_RestartsPeriodicTimerOnTransitionIntoPeriodic)
{
