/**
 * \file    Bsw_ComStack_TxE2E_test.cpp
 ...
 *          CanIf_Transmit() → Can_Write()）は Bsw_ComStack_Tx_ComSendSignal_test.cpp が既に検証
 ...
 *          自体は Bsw_ComStack_Tx_ComSendSignal_test.cpp の対象外（TxTransformCbk=NULL の設定）
 ...
 *          E2EXf_PBCfg.c 自体は Rte 依存を持たないため、Bsw_ComStack_Tx_ComSendSignal_test.cpp
...
class Bsw_TxE2E_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_TxE2E_Test, ComMainFunction_OK_E2EProtectsAndReachesCanHw)
{
    /* 準備 (Arrange) */
...
TEST_F(Bsw_TxE2E_Test, ComMainFunction_OK_CounterIncrementsAcrossSends)
{
    /* 準備 (Arrange) */
