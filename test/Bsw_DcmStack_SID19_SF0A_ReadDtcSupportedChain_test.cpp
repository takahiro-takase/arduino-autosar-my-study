/**
 * \file    Bsw_DcmStack_SID19_SF0A_ReadDtcSupportedChain_test.cpp
 * \brief   UDS SID 0x19/0x0A reportSupportedDTC の、物理層（Can_Hw フェイク）
 *          を起点・終点とするフルコールチェーンテスト（GoogleTest /
 *          CMake native_chain_tests）。
 *
 * \details Bsw_DcmStack_SID19_SF01_ReadDtcCountChain_test.cpp でチェーンの型
 ...
 *          Bsw_DcmStack_SID19_SF01_ReadDtcCountChain_test.cpp と同一（重複
...
class Bsw_DcmStack_SID19_SF0A_ReadDtcSupportedChain_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_DcmStack_SID19_SF0A_ReadDtcSupportedChain_Test,
