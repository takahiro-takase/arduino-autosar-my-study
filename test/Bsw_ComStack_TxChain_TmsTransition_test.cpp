/**
 * \file    Bsw_ComStack_TxChain_TmsTransition_test.cpp
...
class Bsw_ComStack_TxChain_TmsTransition_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ことを示す回帰テスト）。
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_TxChain_TmsTransition_Test, TmsTransition_OK_TriggersImmediateSendWithoutGroupTrigger)
{
