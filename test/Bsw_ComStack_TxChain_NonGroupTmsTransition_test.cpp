/**
 * \file    Bsw_ComStack_TxChain_NonGroupTmsTransition_test.cpp
...
class Bsw_ComStack_TxChain_NonGroupTmsTransition_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_TxChain_NonGroupTmsTransition_Test, NonGroupTmsTransition_OK_TriggersImmediateSendEvenWhenCalledSignalFilterFails)
{
