/**
 * \file    Bsw_ComStack_TxChain_InvalidateSignal_test.cpp
...
class Bsw_ComStack_TxChain_InvalidateSignal_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_TxChain_InvalidateSignal_Test, InvalidateSignal_OK_WritesConfiguredInvalidValueToBuffer)
{
    /* 実行 (Act) */
...
TEST_F(Bsw_ComStack_TxChain_InvalidateSignal_Test, InvalidateSignal_NG_UnconfiguredInvalidValueReturnsServiceNotAvailableWithoutWriting)
{
...
TEST_F(Bsw_ComStack_TxChain_InvalidateSignal_Test, InvalidateSignal_NG_UnknownSignalIdReturnsError)
{
    /* 実行 (Act) + 評価 (Assert) */
    EXPECT_EQ(Com_InvalidateSignal(255U), E_NOT_OK);
}

TEST_F(Bsw_ComStack_TxChain_InvalidateSignal_Test, InvalidateSignal_NG_RxSignalReturnsErrorWithoutReachingSendSignal)
{
