/**
 * \file    Bsw_ComStack_TxChain_RepetitionSequence_test.cpp
...
class Bsw_ComStack_TxChain_RepetitionSequence_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_TxChain_RepetitionSequence_Test, RepetitionSequence_OK_FiresConfiguredNumberOfRepeatsThenStops)
{
    /* 準備 (Arrange) */
...
TEST_F(Bsw_ComStack_TxChain_RepetitionSequence_Test, RepetitionSequence_OK_InitialSendDoesNotConsumeRepeatBudgetEvenWhenElapsedAlreadyExceedsPeriod)
{
...
TEST_F(Bsw_ComStack_TxChain_RepetitionSequence_Test, RepetitionSequence_OK_DoesNotConsumeBudgetWhileCommunicationControlDisabled)
{
...
TEST_F(Bsw_ComStack_TxChain_RepetitionSequence_Test, RepetitionSequence_NG_DoesNotFireBeforePeriodElapsed)
{
...
TEST_F(Bsw_ComStack_TxChain_RepetitionSequence_Test, RepetitionSequence_OK_NewSendSignalRestartsSequence)
{
