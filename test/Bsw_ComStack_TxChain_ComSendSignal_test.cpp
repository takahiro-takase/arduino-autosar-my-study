/**
 * \file    Bsw_ComStack_TxChain_ComSendSignal_test.cpp
...
class Bsw_ComStack_TxChain_ComSendSignal_Test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
// ------------------------------------------------------------
TEST_F(Bsw_ComStack_TxChain_ComSendSignal_Test, ComSendSignal_OK_SetsPendingAndPacksBuffer)
{
    /* 準備 (Arrange) */
...
TEST_F(Bsw_ComStack_TxChain_ComSendSignal_Test, ComSendSignal_NG_UnknownSignalId_DoesNotSetPending)
{
    /* 準備 (Arrange) */
    uint16_t value = 0x1234U;
