...
| SID<br>サービス名 | SubFunc | フレーム例（byte0=PCI） | 可変バイト |
|---|---|---|---|
| 0x10<br>DiagnosticSessionControl | 0x01<br> (Default) | `02 10 01 00 00 00 00 00` | — |
| 0x10<br>DiagnosticSessionControl | 0x03<br> (Extended) | `02 10 03 00 00 00 00 00` | — |
| 0x11<br>ECUReset | 0x01<br> (hardReset) | `02 11 01 00 00 00 00 00` | — |
| 0x11<br>ECUReset | 0x03<br> (softReset) | `02 11 03 00 00 00 00 00` | — |
| 0x14<br>ClearDiagnosticInformation | — | `04 14 FF FF FF 00 00 00` | byte2-4=groupOfDTC（0xFFFFFF 固定） |
| 0x19<br>ReadDTCInformation | 0x01<br> (件数取得) | `03 19 01 MM 00 00 00 00` | byte3=statusMask |
| 0x19<br>ReadDTCInformation | 0x02<br> (DTC 一覧取得) | `03 19 02 MM 00 00 00 00` | byte3=statusMask |
| 0x19<br>ReadDTCInformation | 0x04<br> (FreezeFrame取得) | `06 19 04 HH MM LL RR 00` | byte3-5=DTC コード<br>byte6=recordNumber（固定 0x01） |
| 0x22<br>ReadDataByIdentifier | — | `03 22 HH LL 00 00 00 00` | byte2-3=DID（0x0101 / 0x0102 / 0x0103） |
| 0x3E<br>TesterPresent | 0x00 | `02 3E 00 00 00 00 00 00` | — |
