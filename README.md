...
（例: 0x10→0x50、0x27→0x67）のため、表には記載せず「備考」列には
それ以外の補足情報のみ記載する。
...
| 0x14<br>ClearDiagnosticInformation | × | ○ | — | `04 14 FF FF FF 00 00 00` | byte2-4=groupOfDTC<br>・0xFFFFFF=全クリア<br>・DTCコード指定=1件クリア | **SecurityAccess Level1 必須**（未認証は NRC 0x33） |
