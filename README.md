...
| 0x14<br>ClearDiagnosticInformation | — | `04 14 FF FF FF 00 00 00` | byte2-4=groupOfDTC<br>・0xFFFFFF=全クリア<br>・DTCコード指定=1件クリア | 0x54<br>**extendedSession 限定**（defaultSession は NRC 0x7F）<br>**SecurityAccess Level1 必須**（未認証は NRC 0x33） |
...
| 0x27<br>SecurityAccess | 0x01<br>(requestSeed) | `02 27 01 00 00 00 00 00` | — | 0x67（seed 2 バイト）<br>**extendedSession 限定**（defaultSession は NRC 0x7F） |
