...
**DTC 一覧を取得（confirmedDTC のみ）:**
```
送信 → 0x7E0: [03 19 02 08 00 00 00 00]
...
> **注意**: SID 0x19 subFunc 0x02 は Single Frame の制約上、先頭 1 件のみ返します。
...
# UDS SID 0x19/02: DTC 一覧取得（statusMask=0x08）
[Dcm] SID=0x19
[Dcm 0x19/02] mask=0x08 found=1
[Mcp2515_Send] OK >>>> ID=0x7E8 DLC=8 DATA=[07 59 02 2D 00 01 01 2D]
